...
const TaskDetails = ({ items }) => {
  ...
  // const [priority, setPriority] = useState(oldTask.priority);
  // const [attachments, setAttachments] = useState([]);
  // const [updateAt, setUpdatedAt] = useState(oldTask.updateAt);
  // const [status, setStatus] = useState(oldTask.status);
  ...
  const handleFormSubmit = async (e) => {
    ...
    // try {
    //   // Make an API call to update the task with the editedTask data
    //   const currentDate = new Date().toISOString();
    //   editedTask.updateAt = currentDate;

    //   // Create an updatedTask object with the modified values
    //   await axios.put(`/tasks/updatedTask/${taskId}`, editedTask);
